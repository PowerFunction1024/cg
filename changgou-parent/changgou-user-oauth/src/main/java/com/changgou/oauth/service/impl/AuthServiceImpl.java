...
/**
 * 用户发送请求/user/login?username=zhangsasn&password=zhangsan
 * --->后台系统接收
 * --->模拟postman给认证服务器发送请求[申请令牌] (相当于客户端和认证服务器是用一个服务了)
 * -->令牌给回用户即可
 *
 * 看不懂下面程序的话可以参照老师课堂上面手写的  MyUserLogin.java   逻辑是一样的
 */
@Service
public class AuthServiceImpl implements AuthService {
    ...
    public static void main(String[] args) {
        byte[] decode = Base64Utils.decode("eyJhbGciOiJIUzI1NiJ9".getBytes());
